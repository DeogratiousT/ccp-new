...
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('dashboard.sections.probes.store', $section) }}" method="POST">
                @csrf
                ...
                <div class="row mb-4">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="max_threshold" id="max_threshold" class="form-control @error('max_threshold') is-invalid @enderror" value="{{ old('max_threshold') }}"/>
