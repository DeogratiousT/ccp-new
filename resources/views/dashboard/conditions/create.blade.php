...
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('dashboard.conditions.store') }}" method="POST">
                @csrf
                <div class="row mb-4">
                ...
                <div class="row mb-4">
                    <div class="form-group col-12">
                        ...
                        <input type="text" name="si_unit" id="si_unit" class="form-control @error('si_unit') is-invalid @enderror" value="{{ old('si_unit') }}"/>
